...
* v. 2.1.8 still [contains](https://github.com/magento/magento2/blob/2.1.8/lib/internal/Magento/Framework/DB/Query/BatchIterator.php#L156) this error (use [v. 0.2.0](https://github.com/flancer32/mage2_fix_pr9621/releases/tag/0.2.0) for Magento 2.1.8).
